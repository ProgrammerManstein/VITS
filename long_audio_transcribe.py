...
if __name__ == "__main__":
    ...
    model = whisper.load_model(args.whisper_size, download_root="/root/VITS-fast-fine-tuning/pretrained_models/w/")
    speaker_annos = []
    print(filelist)
    for file in filelist:
        ...
        result = model.transcribe(parent_dir + file,initial_prompt='以下是普通话的句子')#, word_timestamps=True)#, **transcribe_options)
        print("kkkk")
